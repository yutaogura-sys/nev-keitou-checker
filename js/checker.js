...
const DrawingChecker = (() => {
  ...
  const MANUAL_KISO_CHECKS = [
    ...
    { id: 'man_k_demand_note', category: 'man_demand', label: 'デマンドコントロール注記の記載内容', detail: 'デマンドコントロールが必要な場合、「デマンドコントロール機能により充電出力を制御する」旨の注記と、LB率（出力制限割合）が記載されていること。' },
...
- デマンドコントロール注記の記載内容（必要な場合）: 「デマンドコントロール機能により充電出力を制御する」旨の注記とLB率の記載
